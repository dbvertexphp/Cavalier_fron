export const environment = {
  production: true,
  apiUrl: 'http://localhost:5000/api', // Live URL dynamic switch kar sakte ho yahan
  // apiUrl: 'https://api.cavalierlogistic.graphicsvolume.com/api', // Live URL dynamic switch kar sakte ho yahan
  // firebase: {
  ...
  vapidKey: 'BA4O57aJUTCi0BZrUr9n6LTDxJRfs1Wtr8U1dyJUIZAYt2GEk2GgimZJEHNpFsqPMi3pzoZ5SmDVyzFs7Y5yOxY'
};